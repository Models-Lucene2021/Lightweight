...
public class clustering {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int  hitsPerPage = config.getHitsPerPage();
        ...
        clustering
         */
        ArrayList<Document> ecoresFound = ecoreIndexer.query(analyzer, luceneIndexDir,querystr,hitsPerPage);
        for (Document doc : ecoresFound) {
            System.out.println("Cluster Element: "+doc.get("filePath"));
        }
    }
