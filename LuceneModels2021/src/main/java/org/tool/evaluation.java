...
public class evaluation {
    ...
    public static void main(String[] args) throws IOException {
        ...
        evaluateClassification(config);
    }

    public static void evaluateClustering(configuration config) throws IOException {
        ...
        int rounds = 2; //138;276;551 to be changed
        int hitsPerPage = 0;
    ...
    public static void evaluateClassification(configuration config) throws IOException {
        String INDEX_DIRECTORY = config.getIndexDirectory();
        FileUtils.cleanDirectory(new File(INDEX_DIRECTORY));
        String BASEPATH = config.getBasePath();
        String testFolder = config.getTestDirectory();
